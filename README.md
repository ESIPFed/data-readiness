...
The current version of the checklist is available here  (last updated 2023-06-21). The checklist will be maintained and updated by the community.
To assist with the assessment, we have created a fillable Google sheet document. You can make a copy of the Google sheet for your assessment.
Each dataset should be assessed separately as the checklist is  designed for individual datasets. More effort is ongoing to address the need for linked datasets.
